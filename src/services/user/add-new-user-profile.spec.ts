import { BuildNewUserProfile, NewUserProfile, UserRepository } from '../../utilities/types';
...
describe('add-new-user-profile', () => {
    test('should return correct result when invoke successfully', async () => {
        ...
        const mockBuildNewUserProfile: BuildNewUserProfile = jest.fn(() => mockNewUserProfile);
